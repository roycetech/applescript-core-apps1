(*
	...
	@Build:
		./scripts/build-lib.sh 'app-wrappers/Safari/26.2/dec-safari-ui-noncompact'
		...
		on isDefaultGroup()
			...
			tell application "System Events" to tell process "Safari"
				try
					...
					set groupPicker to first menu button of group 1 of toolbar 1 of front window whose value of attribute "AXIdentifier" starts with "Tab Group Picker"
