(*
	...
	@Build:
		./scripts/build-lib.sh app-wrappers/Finder/26.4/finder
...
use decFinderDialog : script "core/dec-finder-dialog"
use decFinderTags : script "core/dec-finder-tags"
...
on new()
	...
	decFinderDialog's decorate(result)
	decFinderTags's decorate(result)
