(*
	Library wrapper for the System Settings app. This was cloned from the 15.0 system-settings.applescript.  
	...
	@Build:
		./scripts/build-lib.sh 'app-wrappers/System Settings/15.0/macOS Sequoia/system-settings'
		
	@Migrated:
		Tue, May 27, 2025 at 02:16:28 PM
*)
...
on new()
	...
	set decAiAndSiri to script "core/dec-system-settings_apple-intelligence-and-siri"
	...
	decAiAndSiri's decorate(result)
