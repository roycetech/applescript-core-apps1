		...
		*)
		on getLastCommand()
			...
			if aShellPrompt then
				...
				set subjectLines to textUtil's split(subject, linefeed)
				try
			...
			set firstLine to first item of textUtil's split(recentBuffer, linefeed)
